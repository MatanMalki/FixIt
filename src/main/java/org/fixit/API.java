...
public class API<S, T>  {
    ...
    {
        this.mMap.put(key, (T) FixItService.getmInstance().getmRestore().get(key));
        FixItService.getmInstance().getmRestore().remove(key);
    }
    ...
    {
        FixItService.getmInstance().getmRestore().put((String) key, this.mMap.get(key));
